...
class Flickr : NSObject {
    ...
    func taskForResource(resource: String, parameters: [String : AnyObject], completionHandler: CompletionHander) -> NSURLSessionDataTask {
        ...
        let urlString = Constants.BaseUrlSSL + mutableResource + self.escapedParameters(mutableParameters)
    ...
    class func errorForData(data: NSData?, response: NSURLResponse?, error: NSError) -> NSError {
        ...
        do {
            ...
            if let parsedResult = parsedResult as? [String : AnyObject], errorMessage = parsedResult[self.Keys.ErrorStatusMessage] as? String {
